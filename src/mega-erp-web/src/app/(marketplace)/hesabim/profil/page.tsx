...
import { User, Check, Package, Heart, MapPin, Lock } from 'lucide-react'
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
      ...
      <div className="flex gap-2 mb-8 border-b border-border flex-wrap">
        <Link href="/hesabim/profil" className="flex items-center gap-2 px-4 py-2.5 text-sm font-medium border-b-2 border-primary text-primary -mb-px transition-colors">
